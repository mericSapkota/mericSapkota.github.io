...
export const projects: Project[] = [
  {
    ...
    tags: ["Solidity", "Java SpringBoot", "React", "Ethereum"],
    year: 2026,
  ...
  },
  {
    ...
    blurb: "A full-stack Blockchain based donation platform built with React and Spring Boot.",
    tags: ["Solidity", "React", "Spring Boot", "Ethereum"],
    year: 2026,
    repo: "https://github.com/mericSapkota/Charity-App-Blockchain-SpringBoot-React",
    color: "text-gold",
  },
  {
    name: "Simple E-commerce",
    blurb: "A storefront built with Zustand for state, React Hook Form for checkout, Postgres, and Tailwind.",
    tags: ["typescript", "zustand", "postgres", "esewa", "tailwindcss"],
    year: 2026,
