...
const STAGES = [
  {
    ...
    title: 'Projects',
    description:
      'Tools, apps and experiments — from weekend hacks to things people actually use.',
    footer: '6 entries →',
  },
  {
    href: '/writeups',
    ...
    title: 'CTF Writeups',
    description:
      'Walkthroughs from competitions — web, pwn, crypto, forensics and misc, solved and explained.',
    footer: '12 entries →',
  },
  {
    href: '/blog',
      ...
      >
        <div className="pt-11 pr-8 pb-14 pl-8">
          ...
          <p className="m-0 mt-5 max-w-[32ch] text-[26px] leading-[1.4]">
            Security researcher &amp; builder. I break things on purpose, write down how, and
            ship the tools I wish existed.
          </p>
      ...
      <section className="pt-4 pb-10">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          {STAGES.map((stage) => (
            ...
            >
              <span className={`font-display text-[9px] ${stage.kickerColor}`}>
                {stage.kicker}
              </span>
